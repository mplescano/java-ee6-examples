...
import com.illucit.ejbremote.server.CalculatorBean;
import com.illucit.ejbremote.server.CounterBean;
import com.illucit.ejbremote.server.RemoteCalculator;
import com.illucit.ejbremote.server.RemoteCounter;
...
public class RemoteEJBClient {
    ...
    private static RemoteCalculator lookupRemoteStatelessCalculator() throws NamingException {
        final Hashtable<Object, Object> jndiProperties = new Hashtable<>();
        //jndiProperties.put(Context.URL_PKG_PREFIXES, "org.jboss.ejb.client.naming");
        jndiProperties.put(INITIAL_CONTEXT_FACTORY, "org.apache.openejb.client.RemoteInitialContextFactory");
        jndiProperties.put(PROVIDER_URL, "http://localhost:8080/tomee/ejb");
        ...
        return (RemoteCalculator) context.lookup("CalculatorBeanRemote");
    }
    ...
    private static RemoteCounter lookupRemoteStatefulCounter() throws NamingException {
        ...
        return (RemoteCounter) context.lookup("CounterBeanRemote");
    }
