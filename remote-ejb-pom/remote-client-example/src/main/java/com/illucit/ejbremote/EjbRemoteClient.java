...
public class EjbRemoteClient {
	...
	public static void main(String[] args) {
		...
		String ejbUrl = "ExampleServiceImplRemote";
		...
		System.out.println("Home Dir: " + systemProperties);
	...
	private static Context createRemoteEjbContext(String host, String port) throws NamingException {
		...
		props.put(INITIAL_CONTEXT_FACTORY, "org.apache.openejb.client.RemoteInitialContextFactory");
		...
		props.put(PROVIDER_URL, "http://" + host + ":" + port + "/tomee/ejb");
